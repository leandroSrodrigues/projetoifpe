        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h4 class="sub-header">Nova Denúncia</h4>
            ...
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="../img/v.png" width="100" height="100" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Atendidas</h4>
              <span class="text-muted">Módulo de Denúncias</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img src="../img/pendente.png "  width="100" height="100" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Pendentes</h4>
              <span class="text-muted">Acesse</span>
            </div>
						 <div class="col-xs-6 col-sm-3 placeholder">
              <img src="../img/atendimento.png" width="100" height="100" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Em Atendimento</h4>
              <span class="text-muted">Acesse</span>
            </div>
						 <div class="col-xs-6 col-sm-3 placeholder">
              <img src="../img/outro.png" width="100" height="100" class="img-responsive" alt="Generic placeholder thumbnail">
              <h4>Outro Status</h4>
              <span class="text-muted">Acesse</span>
            </div>
          </div>
